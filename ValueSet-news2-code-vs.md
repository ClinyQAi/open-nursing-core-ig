...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/ValueSet/news2-code-vs | *Version*:0.1.0 |
| Draft as of 2026-01-03 | *Computable Name*:NEWS2CodeValueSet |
...
```json
{
  ...
  "id" : "news2-code-vs",
  "url" : "https://opennursingcoreig.com/ValueSet/news2-code-vs",
  "version" : "0.1.0",
