...
| | |
| :--- | :--- |
| *Official URL*:https://opennursingcoreig.com/ValueSet/onc-cfs-vs | *Version*:0.1.0 |
| Draft as of 2026-01-03 | *Computable Name*:ClinicalFrailtyScaleVS |
...
```json
{
  ...
  "id" : "onc-cfs-vs",
  "url" : "https://opennursingcoreig.com/ValueSet/onc-cfs-vs",
  "version" : "0.1.0",
